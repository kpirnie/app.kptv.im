...
# Cleanup First
php $PWD/vendor/kevinpirnie/kpt-cache/src/cache/cleaner.php --cleanup

# Full system cleanup
php $PWD/vendor/kevinpirnie/kpt-cache/src/cache/cleaner.php --clear_all
rm -rf /tmp/kpt_* $PWD/.cache/*
