...
class KPTV_Stream_Other extends KPTV_Base {
    ...
    public function searchPaginated(string $search, int $per_page, int $offset, string $sort_column = 's_orig_name', string $sort_direction = 'ASC', array $filters = []): array|bool {
